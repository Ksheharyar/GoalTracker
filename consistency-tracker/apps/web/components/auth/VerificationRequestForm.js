...
function VerificationRequestForm() {
  ...
  if (success) {
    return (
      <Card className="mx-auto w-full max-w-xl border border-white/10 bg-slate-950/50 p-8 text-center">
        ...
        <h2 className="mt-6 font-display text-3xl font-semibold tracking-tight text-white">Check your inbox</h2>
  ...
  return (
    <Card className="mx-auto w-full max-w-xl border border-white/10 bg-slate-950/50 p-8">
      ...
      <h2 className="mt-6 font-display text-2xl font-semibold text-white">Verify your email</h2>
      <p className="mt-3 text-sm leading-7 text-slate-300">Enter the email you used to sign up and we’ll send a verification link.</p>
